...
public class NotificationFragment extends Fragment {
    ...
    private RecyclerView notification_rcv2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        item_rcv1.add(new Notification_Recyclerview1(R.drawable.notification_store1,"Thông báo từ cửa hàng Archiiro",
                "Thông báo từ cửa hàng Archiiro"));
        item_rcv1.add(new Notification_Recyclerview1(R.drawable.notification_store1,"Thông báo từ cửa hàng Archiiro",
                "Thông báo từ cửa hàng Archiiro"));
        item_rcv1.add(new Notification_Recyclerview1(R.drawable.notification_store1,"Thông báo từ cửa hàng Archiiro",
                "Thông báo từ cửa hàng Archiiro"));
        ...
        notifi_rcv1.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
